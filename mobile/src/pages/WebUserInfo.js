        ...
        <div className="flex web">
            ...
            <div className='flex'>
                <div className='contents'>
                    ...
                    <button type="button" className='darkButton' onClick={() => navigate(`/WebDeviceInfo/${userData[id].id}`)} style={{width:"300px", height:"100px", margin:"auto", fontSize:"35px"}}>디바이스 상세</button>
                </div>
            </div>
        </div>
    );
